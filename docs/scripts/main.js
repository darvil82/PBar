...
const PBAR_INFO = {	// Define the wiki pages, and their corresponding tooltip
	...
	task_wrapper: ["task_wrapper-function-decorator", "Automatically changes the prange of the progress bar depending on the number of function calls inside the decorated function.<br>This will also call the <span class='pre'>PBar.step()</span> method after each function call processed."],
